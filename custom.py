...
disable_gi = "yes"                # Disables GI (SDFGI/VoxelGI)
disable_ss_effects = "yes"        # Disables screen-space effects (SSAO/SSIL/SSR)
disable_volumetric_fog = "yes"    # Disables volumetric fog
disable_dof = "yes"               # Disables depth of field
disable_glow = "yes"              # Disables glow/bloom effects
